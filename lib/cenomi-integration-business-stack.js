  ...
  constructor(scope, id, props) {
    ...
    const pickFileTransfersLambda = new lambda.Function(
      ...
      `${props.resourcePrefix}pickFileTransfersLambda`,
      {
        ...
        environment: {
          lockTbale: `${resourcePrefix}${dbTables.FileTransferLockTable}`,
          REGION: this.region,
        },
      }
    );
    ...
    const getAllInditexTransfer = new lambda.Function(
      this,
      `${props.resourcePrefix}getAllInditexTransfer`,
      {
        ...
        code: lambda.Code.asset("lambdas/fileTransfers/getAllInditexTransfer"),
    ...
    api.root
      ...
      .addMethod("GET", new apigw.LambdaIntegration(getAllInditexTransfer));
    api.root
