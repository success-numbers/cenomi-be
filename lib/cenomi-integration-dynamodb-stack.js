...
class CenomiIntegrationDynamoDbStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        // });
        const fileTransferAuditTable = new dynamodb.Table(this, `${resourcePrefix}${dbTables.FileTransferAuditTable}`, {
            tableName: `${resourcePrefix}${dbTables.FileTransferAuditTable}`,
            partitionKey: {
                name: "PK",
                type: dynamodb.AttributeType.STRING,
            },
        ...
        fileTransferSyncTable.addGlobalSecondaryIndex({
