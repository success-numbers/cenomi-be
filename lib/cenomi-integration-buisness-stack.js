...
class CenomiIntegrationBusinessStack extends Stack {
    constructor(scope, id, props) {
        ...
        const dataTableExport = cdk.Fn.importValue("cenomi-data-table");
        const dataTable = dynamodb.Table.fromTableName(this, "CenomiImportedDataTable", dataTableExport);
        const chunkTableExport = cdk.Fn.importValue("cenomi-chunk-table");
        const chunkTable = dynamodb.Table.fromTableName(this, "CenomiImportedChunkTable", chunkTableExport);
        const FileTransferDataTableExport = cdk.Fn.importValue("cenomi-file-transfer-data-table");
        const FileTransferDataTable = dynamodb.Table.fromTableName(this, "CenomiImportedFileTransferDataTable", FileTransferDataTableExport);
        // Import Lambda role using ARN
        const lambdaRole = iam.Role.fromRoleArn(
            this,
            'ImportedLambdaRole',
            `arn:aws:iam::${props.env.account}:role/${props.resourcePrefix}LambdaRole`, // Update the account ID
            {
                mutable: false,
            }
        );
        ...
        const putFileTransfers =  new lambda.Function(this, `${props.resourcePrefix}putFileTransfersLambda`, {
            ...
            environment: {
                tableName: FileTransferDataTable.tableName,
                userPoolId: props.attributes.userPoolId,
                REGION: this.region
            }
        });
        const getTransfersLambda = new lambda.Function(this, `${props.resourcePrefix}getAllTransferLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const syncDatabricksLambda = new lambda.Function(this, `${props.resourcePrefix}syncDatabricksLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const syncDatabricksTriggerLambda = new lambda.Function(this, `${props.resourcePrefix}syncDatabricksTriggerLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const syncDatabricksProcessingLambda = new lambda.Function(this, `${props.resourcePrefix}syncDatabricksProcessingLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const getTransfersByIdLambda = new lambda.Function(this, `${props.resourcePrefix}getTransfersByIdLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const getAllLocationLambda = new lambda.Function(this, `${props.resourcePrefix}getAllLocationLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const searchTransfersByDestLambda = new lambda.Function(this, `${props.resourcePrefix}SearchTransfersByIdAndDestLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const pickTransferLambda = new lambda.Function(this, `${props.resourcePrefix}pickTransferLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const getRepickTransferLambda = new lambda.Function(this, `${props.resourcePrefix}getRepickTransferLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const submitTransferLambda = new lambda.Function(this, `${props.resourcePrefix}submitTransferLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const updateTransferStatusLambda = new lambda.Function(this, `${props.resourcePrefix}updateTransferStatusLambda`, {
            runtime: props.runtime,
            layers: allLayersList,
            role: lambdaRole,
        ...
        const api = apigw.RestApi.fromRestApiAttributes(this, `${props.resourcePrefix}ApiGateway`, {
            restApiId: cdk.Fn.importValue('cenomi-api-gateway-export'),
            rootResourceId: cdk.Fn.importValue('cenomi-api-gateway-resource-export'),
        });
        ...
        .addMethod("GET", new apigw.LambdaIntegration(searchTransfersByDestLambda),{
            // authorizationType: apigw.AuthorizationType.COGNITO,
            // authorizer: {authorizerId: props.authorizer.attrAuthorizerId},
        });
        api.root
        ...
        .addMethod("POST", new apigw.LambdaIntegration(updateTransferStatusLambda),{
            // authorizationType: apigw.AuthorizationType.COGNITO,
            // authorizer: {authorizerId: props.authorizer.attrAuthorizerId},
        });
