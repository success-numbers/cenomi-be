...
class CenomiIntegrationLayersStack extends Stack {
  ...
  new Lambda.LayerVersion(this,`${resourcePrefix}${npmLayerName}`,{
    code: Lambda.Code.fromAsset('layers/cenomi-integration-package-layer'),
...
module.exports = { CenomiIntegrationLayersStack };
